...
public sealed class AppVersionGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(combined, static (ctx, input) =>
        {
            ...
            string writerSource = GenerateVersionFileWriter(version, branch, commitId);
    ...
    private static string GenerateVersionFileWriter(string version, string branch, string commitId)
    {
        return $$"""
            // <auto-generated/>
