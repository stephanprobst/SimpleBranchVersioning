...
{
    private static readonly DiagnosticDescriptor VersionDetectedInfo = new(
        id: "SBV001",
        title: "Version detected",
        messageFormat: "SimpleBranchVersioning: {0} (branch: {1}, commit: {2})",
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(combined, static (ctx, input) =>
        {
            ...
            // Report version info diagnostic (shows in verbose output)
